...
for learningRate in learningRates:
    ...
    for epochSetting in epochSettings:
        ...
        weightVector, bias, epochData = sp.simple_perceptron(trainingData, num=19, lr=learningRate, epochs=epochSetting)
        ...
        print('Cross Validation:', t.crossValidation(sp.simple_perceptron, folds, 19, learningRate, epochSetting))
