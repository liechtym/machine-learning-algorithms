import aggressive_perceptron as ap
...
for learningRate in learningRates:
    ...
    for marginSetting in marginSettings:
        print('-------------------Margin: ' + str(marginSetting) + '-------------------')
        for epochSetting in epochSettings:
            print('-------------Epoch: ' + str(epochSetting) + '-------------')
            print('Learning Rate:', learningRate)
            print('Margin', marginSetting)
            print('Epochs:', str(epochSetting))
            weightVector, bias, epochData = ap.aggressive_perceptron(trainingData, num=19, lr=learningRate, epochs=epochSetting, margin=marginSetting)
            ...
            print('Cross Validation:', t.crossValidation(ap.aggressive_perceptron, folds, 19, learningRate, epochSetting))
