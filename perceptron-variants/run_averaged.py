import averaged_perceptron as ap
...
for learningRate in learningRates:
    ...
    for epochSetting in epochSettings:
        ...
        weightVector, bias, epochData = ap.averaged_perceptron(trainingData, num=19, lr=learningRate, epochs=epochSetting)
        ...
        print('Cross Validation:', t.crossValidation(ap.averaged_perceptron, folds, 19, learningRate, epochSetting))
