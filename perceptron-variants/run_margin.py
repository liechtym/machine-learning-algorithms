import margin_perceptron as mp
...
for learningRate in learningRates:
    ...
    for marginSetting in marginSettings:
        ...
        for epochSetting in epochSettings:
            ...
            weightVector, bias, epochData = mp.margin_perceptron(trainingData, num=19, lr=learningRate, epochs=epochSetting, margin=marginSetting)
            ...
            print('Cross Validation:', t.crossValidation(mp.margin_perceptron, folds, 19, learningRate, epochSetting))
